...
export const INFO_CLIENT = 'http://73.131.65.17:8000/subgraphs/name/pancakeswap/exchange'
export const BLOCKS_CLIENT = 'http://73.131.65.17:8000/subgraphs/name/pancakeswap/blocks'
