...
export const INFO_CLIENT = 'https://www.saidiacapital.com/subgraphs/name/pancakeswap/exchange'
export const BLOCKS_CLIENT = 'https://www.saidiacapital.com/subgraphs/name/pancakeswap/blocks'
